              ...
              <div class="row">
                <div class="col-lg-4">
                  <div class="form-group">
                    ...
                    <input type="hidden" name="id_tagih" id="id_tagih" value="<?= $edit_penagihan['id'] ?>">
                    ...
                    ?>
                    <?php if($jual['id'] == $edit_penagihan['id_jual']) : ?>
                    <input type="hidden" name="idJual" value="<?= $jual['id'] ?>">              
                    <input type="text" name="kode" value="<?= '['.$jual['kodeBarangJual']. ' - '. $jual['Nama_Customer'].']' ?>" class="form-control" readonly>
                  </div>
                </div>
                ...
                <div class="col-lg-4">
                  <div class="form-group">
                    ...
                    <input type="date" name="tanggal" id="tanggal" class="form-control" value="<?= $jual['tglJual'] ?>" readonly>
                  </div>
                </div>
                ...
                <div class="col-lg-4">
                  <div class="form-group">
                    ...
                    <input type="text" name="customer" id="customer" class="form-control" value="<?= $jual['Nama_Customer'] ?>" readonly>
                  </div>
                </div>
                ...
                <div class="col-lg-3">
                  <div class="form-group">
                    <label>Barang</label>
                    <input type="text" name="barangjual" id="barangjual" class="form-control" value="<?= $jual['namaBarangJual'] ?>" readonly>
                  </div>
                </div>
                ...
                <div class="col-lg-3">
                  <div class="form-group">
                    <label>Jumlah</label>
                    <input type="text" name="jumlah" id="jumlah" class="form-control" value="<?= $jual['jumlahJual'].' '.$jual['satuan'].' x '.rupiah($jual['hargaJual']) ?>" readonly>
                  </div>
                </div>  
                ...
                <div class="col-lg-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="sisa_hutang" id="sisa_hutang" value="<?= rupiah($edit_penagihan['sisa_hutang']) ?>" class="form-control" readonly>
                  </div>
                </div>                
                ...
                <div class="col-lg-4">
                  <div class="form-group">
                    ...
                    <select name="jangka_waktu" id="jangka_waktu" class="custom-select form-control">
                      ...
                      <option value="1" <?= $edit_penagihan['jangka_waktu'] == 1 ? 'selected' : '' ?>>1 Bulan</option>
                      <option value="2" <?= $edit_penagihan['jangka_waktu'] == 2 ? 'selected' : '' ?>>2 Bulan</option>
                      <option value="3" <?= $edit_penagihan['jangka_waktu'] == 3 ? 'selected' : '' ?>>3 Bulan</option>
                      <option value="4" <?= $edit_penagihan['jangka_waktu'] == 4 ? 'selected' : '' ?>>4 Bulan</option>
                      <option value="5" <?= $edit_penagihan['jangka_waktu'] == 5 ? 'selected' : '' ?>>5 Bulan</option>
                      <option value="6" <?= $edit_penagihan['jangka_waktu'] == 6 ? 'selected' : '' ?>>6 Bulan</option>
                      <option value="7" <?= $edit_penagihan['jangka_waktu'] == 7 ? 'selected' : '' ?>>7 Bulan</option>
                      <option value="8" <?= $edit_penagihan['jangka_waktu'] == 8 ? 'selected' : '' ?>>8 Bulan</option>
                      <option value="9" <?= $edit_penagihan['jangka_waktu'] == 9 ? 'selected' : '' ?>>9 Bulan</option>
                      <option value="10" <?= $edit_penagihan['jangka_waktu'] == 10 ? 'selected' : '' ?>>10 Bulan</option>
                      <option value="11" <?= $edit_penagihan['jangka_waktu'] == 11 ? 'selected' : '' ?>>11 Bulan</option>
                      <option value="12" <?= $edit_penagihan['jangka_waktu'] == 12 ? 'selected' : '' ?>>12 Bulan</option>
                    </select>                    
                  </div>                  
                </div>
                ...
                <div class="col-lg-4">
                  <div class="form-group">
                    ...
                    <input type="text" name="perbulan" id="perbulan" class="form-control" value="<?= $edit_penagihan['angsuran_perbulan'] ?>">
                  </div>
                </div>                
                ...
                <div class="col-lg-4">
                  <div class="form-group">
                    ...
                    <select name="status" class="custom-select form-control">
                      ...
                      <option value="Lunas" <?= $edit_penagihan['status'] == 'Lunas' ? 'selected' : '' ?>>Lunas</option>
                      <option value="Belum Lunas" <?= $edit_penagihan['status'] == 'Belum Lunas' ? 'selected' : '' ?>>Belum Lunas</option>
                    </select>                    
                  </div>                  
                </div>
...
$(document).ready(function() {
  $(document).on('change, keyup', '#jangka_waktu', function(){
    var totalHutang = parseInt($('#subtotal').val());
  ...
  $('#penagihan-form').submit(function(e){
    ...
    $.ajax({
      method: "POST",
      url: "<?= site_url('penagihan/update/').$this->uri->segment(3) ?>",
      data: $(this).serialize(),
      dataType: "JSON",
      beforeSend: function(){
      ...
      success: function(data){
        ...
        if (data.status == "success") {
          ...
          window.location.href="<?= site_url('penagihan/edit/').$this->uri->segment(3) ?>";
        } else {
  ...
  loadAngsuran();
    ...
    function loadAngsuran(){
        $.ajax({
            url: "<?= site_url('penagihan/getPenagihanDetail/' . $this->uri->segment(3)) ?>",
            method: 'GET',
            dataType: 'JSON',
            beforeSend: function(){
            ...
            success: function(response){
                ...
                $.each(response.data,function(k, v){
                    ...
                    html += '<tr class="text-center">'
                            + '<td>'
                            +     '<div class="form-group">'
                            +       '<input type="hidden" class="form-control" id="id_penagihan_detail" name="id_penagihan_detail" value="'+v.id_penagihan_detail+'">'  
                            +       '<input type="hidden" class="form-control" id="id_penagihan" name="id_penagihan" placeholder="" readonly value="'+v.id_penagihan+'">'                                                      
                    ...
                    html += '<td>'
                            +   '<div class="form-group">'
                            +       '<button type="button" class="btn btn-sm btn-danger" onclick="deleteAngsuran('+v.id_penagihan_detail+')"><i class="fa fa-trash"></i>'
                            +       '</button>'
                            +   '</div>'
                            +'</td>';
...
function addAngsuran()
  ...
  function updateAngsuran(id){
    ...
    var id_penagihan_detail = $(id).closest('tr').find('#id_penagihan_detail').val();
    var id_penagihan = $(id).closest('tr').find('#id_penagihan').val();
    $.ajax({
        url: "<?= site_url('penagihan/updatePenagihanDetail/') ?>" + id_penagihan_detail,
        method: 'post',
        data: {
        angsuran: angsuran,
  ...
  function batalAngsuran(id){
    ...
    var id_penagihan = $(id).closest('tr').find('#id_penagihan').val();
      $.ajax({
          url: "<?= site_url('penagihan/batalAngsuran/') ?>" + id_penagihan_detail,
          method: 'post',
          data: {
          jumlah_pembayaran: jumlah_pembayaran,
          denda: denda,
    ...
    function createAngsuran(id)
    {
        ...
        $.ajax({
          url: '<?= site_url('penagihan/createPenagihanDetail') ?>',
          method: 'post',
          data: {
          angsuran: angsuran,
          jumlah_pembayaran: jumlah_pembayaran,
    ...
    {
        $.ajax({
          url: '<?= site_url('penagihan/deletePenagihanDetail/') ?>' + id,
          method: 'post',
          success: function(response){
            loadAngsuran();
